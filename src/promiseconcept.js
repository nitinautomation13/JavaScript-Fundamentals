...
myPromise
 ...
 dataPromise
    ...
    //Promise - means to handle the asynchonas task , asynchronas task means those task which are actually taking the time
    //so if we really want to handle those asynchronas operations which are taking some time in particular sequence way then the 
    //promise are really good copmare to callbackhell.
